// The diff data model plus pure hunk/line helpers, shared by the GitHub and
// local-git sources. A finding's line must resolve onto a changed hunk or it
// cannot be posted as an inline comment. Ported from the review-pr command.
...
// Build a path -> hunks index from the changed files.
